 ...
 * @author Jay
 */
public class SignedUpSuccess extends javax.swing.JFrame {

    /**
     * Creates new form SignedUpSuccess
     */
    public SignedUpSuccess() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("You have signed up successfully");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(50, 70, 300, 40);

        jPanel8.setBackground(new java.awt.Color(29, 106, 185));
        jPanel8.setLayout(null);
        getContentPane().add(jPanel8);
        jPanel8.setBounds(370, 0, 10, 300);
        ...
        jPanel7.setBounds(0, 270, 400, 10);
    ...
    public static void main(String[] call) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignedUpSuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignedUpSuccess().setVisible(true);
            }
        });
    }
